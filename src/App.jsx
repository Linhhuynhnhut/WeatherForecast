...
import {WeatherCard, BackgroundLayout, MiniCard} from './Components'
    ...
    <div className='w-full h-screen text-white'>
      <nav className='w-full p-3 flex justify-between item-center'>
        ...
        <div className='bg-white w-[15rem] overflow-hidden shadow-2xl rounded flex items-center p-2 gap-2'>
          ...
          }} type="text" className='focus:outline-none w-full text-lg text-[#212121]' value={input} onChange={ e => setInput(e.target.value)}/>
        </div>
      </nav>
